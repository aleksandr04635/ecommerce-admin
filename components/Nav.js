...
export default function Nav({ show }) {
  ...
  const activeLink = inactiveLink + " bg-white text-primary rounded-l-lg pl-2 "; //" bg-highlight text-black rounded-sm";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-800 p-4 pr-0 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"
      }
    >
